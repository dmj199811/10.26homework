    ...
    <el-dialog :title="title" :visible.sync="visible" @close="dialogCloseHandler">
      <el-form :model="waiter" :rules="rules" ref="waiterForm">
        ...
        <el-form-item label="状态" label-width="100px" prop="telephone">
          <el-input v-model="waiter.status" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" label-width="100px" prop="telephone">
          <el-input v-model="waiter.password" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods:{
    ...
    toDetailsHandler(waiter){
      ...
      this.$router.push({
        path:"/waiter/details",
        query:{id:waiter.id,telephone:waiter.telephone,password:waiter.password,
        realname:waiter.realname,status:waiter.status,photo:waiter.photo}
      })
    },
